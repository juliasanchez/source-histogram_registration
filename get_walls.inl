//void get_walls(pcl::PointCloud<pcl::PointNormal>::Ptr cloud_in, float lim, int axis, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_filtered)
//{
//    float dot;
...
//        {
//            case 0 :
//                dot=cloud_in->points[i].normal_x;
//                break;
//            case 1 :
//                dot=cloud_in->points[i].normal_y;
//                break;
//            case 2 :
//                dot=cloud_in->points[i].normal_z;
//                break;
//            default:
//                cout<<"Error, bad axis\n";
//                break;
